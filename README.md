...
Click on this link to see the front end of this project [hello-rails-back-end](https://github.com/iamchristianani/hello-rails-back-end).
...
Clone this [repository](https://github.com/iamchristianani/hello-react-front-end.git) to your desired folder:

```sh
  cd my-folder
  git clone https://github.com/iamchristianani/hello-react-front-end.git
...
Feel free to check the [issues page](https://github.com/iamchristianani/hello-react-front-end/issues).
